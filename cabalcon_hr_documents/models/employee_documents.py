...
class HrEmployeeDocument(models.Model):
    ...
    name = fields.Char(string='Document', required=True, copy=False, help='You can give your'
                                                                                 'Document number.')
    ...
    document_type = fields.Many2one('hr.employee.document.type', string="Tipo de docuemnto", help="Tipo de documento")
...
class HrEmployee(models.Model):
    ...
    def document_view(self):
        ...
        return {
            'name': _('Documents'),
            'domain': domain,
            'res_model': 'hr.employee.document.type',
