...
class AccountMoveDestiny(models.Model):
    _name = "account.move.destiny"
    _description = "Asiento de Destino"

    name = fields.Char(string='Referencia', required = True)
    company_id = fields.Many2one('res.company', string='Compañia', change_default=True, required=True, readonly=True,
    ...
    date_to = fields.Date(string='Fecha Desde', copy=False, required = True, readonly=True, states={'draft': [('readonly', False)]})
    date_from = fields.Date(string='Fecha Hasta', copy=False, required=True, readonly=True, states={'draft': [('readonly', False)]})
