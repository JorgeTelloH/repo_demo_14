...
class ReportAmountBalancesOptimizedNative(models.Model):
	...
	report_amount_balances_optimized_line_ids = fields.One2many('report.amount.balances.optimized.native.line' , 'report_amount_balances_optimized_id' , string="Balance de Sumas y Saldos", readonly=True)
